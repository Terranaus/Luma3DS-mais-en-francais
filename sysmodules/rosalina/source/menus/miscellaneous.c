...
void MiscellaneousMenu_SwitchBoot3dsxTargetTitle(void)
{
    ...
    if (compareTids(newTid, HBLDR_DEFAULT_3DSX_TID))
        miscellaneousMenu.items[0].title = "Changez le titre hb. sur l'application actuelle.";
    else
        miscellaneousMenu.items[0].title = "Changer le titre hb. en " HBLDR_DEFAULT_3DSX_TITLE_NAME;
...
void MiscellaneousMenu_ChangeMenuCombo(void)
{
    ...
    posY = Draw_DrawString(10, posY + SPACING_Y, COLOR_WHITE, "Veuillez saisir le nouveau combo :");
