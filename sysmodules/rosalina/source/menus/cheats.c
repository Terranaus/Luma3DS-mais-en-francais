...
static Result Cheat_MapMemoryAndApplyCheat(u32 pid, CheatDescription* const cheat)
{
    ...
    if (R_SUCCEEDED(res))
    {
        ...
        {
            sprintf(failureReason, "Le processus de debogage a echoue");
            svcCloseHandle(processHandle);
        }
    }
    else
    {
        sprintf(failureReason, "Echec du processus d'ouverture");
    }
    return res;
}
...
void RosalinaMenu_Cheats(void)
{
    ...
    if (titleId == 0 || cheatCount == 0)
    {
        do
        {
            ...
            {
                Draw_DrawFormattedString(10, 30, COLOR_WHITE, "Aucun cheat trouve pour le titre %016llX", titleId);
            }
    ...
    else
    {
        ...
        do
        {
            ...
            if (R_SUCCEEDED(r))
            {
                Draw_DrawFormattedString(10, 10, COLOR_TITLE, "Liste de cheat");
