...
static const char *g_title = "Chargeur de plugins";
...
void        PluginLoader__UpdateMenu(void)
{
    ...
    {
        "Chargeur de plugins : [Désactivé]",
        "Chargeur de plugins : [Activé]"
    };
...
{
	Handle loaderHandle;
    Result res = srvGetServiceHandle(&loaderHandle, "Chargeur");
